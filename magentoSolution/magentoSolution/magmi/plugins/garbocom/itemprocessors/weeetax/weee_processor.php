...
class WeeetaxItemProcessor extends Magmi_ItemProcessor
{
    ...
    public function processItemAfterId(&$item, $params = null)
    {
        ...
        $weeattrnames = $this->getParam("WEEE:attributes", "rf_fee");
        ...
        foreach ($wattrs as $wattr) {
            if (isset($item[$wattr]) && $item[$wattr] != "") {
                ...
                if (count($attrinfo) == 0) {
                    ...
                    $country = $this->getParam("WEEE:country", "US");
		    $state = $this->getParam("WEEE:state", "12");
                    ...
                    //foreach ($wsids as $wsid) {
                        ...
                        $data = array_merge($data,
                            array(0, $pid, $country, $item[$wattr], $state, $attrinfo["attribute_id"],
    ...
    {
        return array("WEEE:country","WEEE:state","WEEE:attributes");
    }
