...
class ClearProductandcategoryUtility extends Magmi_UtilityPlugin
{
    ...
    public function runUtility()
    {
        ...
        $tables = array("catalog_product_bundle_option","catalog_product_bundle_option_value",
            ...
            "catalog_product_entity_group_price","catalog_product_entity_url_key","catalog_product_index_eav",
            "catalog_product_index_price","catalog_product_index_eav","catalog_product_index_eav_idx",
            "catalog_product_index_price_idx","catalog_product_index_group_price","catalog_product_index_website",
            "catalog_product_bundle_price_index","report_viewed_product_index",
            "cataloginventory_stock_item","cataloginventory_stock_status",

            "catalog_category_product_index_tmp","catalog_category_product_index_cl",
            "catalog_category_entity","catalog_category_entity_datetime","catalog_category_entity_decimal", 
            "catalog_category_entity_int","catalog_category_entity_text","catalog_category_entity_varchar",
