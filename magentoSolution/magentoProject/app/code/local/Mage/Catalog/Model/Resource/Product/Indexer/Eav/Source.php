    ...
    extends Mage_Catalog_Model_Resource_Product_Indexer_Eav_Abstract
{
    ...
    protected function _prepareSelectIndex($entityIds = null, $attributeId = null)
    {
        ...
        $this->_addAttributeToSelect($subSelect, 'status', 'd.entity_id', 's.store_id', $statusCond, false, true);
        ...
        //$select->where(Mage::getResourceHelper('catalog')->getNotNullCondition('pid.value'));
